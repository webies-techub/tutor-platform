    ...
    >
      <div className="relative">
        {course.thumbnail_path ? (
          <img
            src={mediaUrl(course.thumbnail_path)}
            alt={course.title}
        ...
        <span className="absolute top-3 left-3 badge bg-white/90 backdrop-blur text-blue-700 shadow-sm capitalize">
          {course.type}
        </span>
      </div>
      <div className="p-5 flex flex-col flex-1">
        ...
        <h3 className="mt-1.5 font-display font-bold text-slate-900 leading-snug group-hover:text-blue-700 transition-colors line-clamp-2">
          {course.title}
        </h3>
        {course.tutor && (
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
          ...
          <span className="text-sm text-blue-600 font-semibold group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
            View course
